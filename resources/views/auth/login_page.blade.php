...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ URL::asset ('user/assets/global/plugins/select2/css/select2.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{ URL::asset ('user/assets/global/plugins/select2/css/select2-bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{ URL::asset ('user/assets/pages/css/login-4.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="logo.png" style="height:30px; width:auto;" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="{{ route('login_process') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input id="email" class="form-control placeholder-no-fix  @error('email') is-invalid @enderror" type="email" autocomplete="off" placeholder="example@email.com" name="email" />
                        @error('email')
                            <span class="invalid-feedback" role="alert">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2020 &copy; HATI S1. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <script src="{{ URL::asset ('user/assets/global/plugins/jquery-validation/js/jquery.validate.min.js')}}" type="text/javascript"></script>
        <script src="{{ URL::asset ('user/assets/global/plugins/jquery-validation/js/additional-methods.min.js')}}" type="text/javascript"></script>
        <script src="{{ URL::asset ('user/assets/global/plugins/select2/js/select2.full.min.js')}}" type="text/javascript"></script>
        <script src="{{ URL::asset ('user/assets/global/plugins/backstretch/jquery.backstretch.min.js')}}" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="{{ URL::asset ('user/assets/global/scripts/app.min.js')}}" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="{{ URL::asset ('user/assets/pages/scripts/login-4.min.js')}}" type="text/javascript"></script>
